view: card_transactions_with_zip {
  derived_table: {
    sql_trigger_value: select max(trans_date) from `mzcdsc-team-200716.Looker_Demo_retail_banking.card_transactions`;;
    sql: SELECT
      ...
      FROM
          `mzcdsc-team-200716.Looker_Demo_retail_banking.card_transactions`  AS card_transactions,
