view: card_transactions {
  sql_table_name: `mzcdsc-team-200716.Looker_Demo_retail_banking.card_transactions` ;;
  ...
  dimension: category_average_amount {
    ...
    group_label: "Category"
    type: number
    sql:(select avg(cast(t.amount as FLOAT64)) from  `mzcdsc-team-200716.Looker_Demo_retail_banking.card_transactions` as t where t.category = ${TABLE}.category);;
  }
